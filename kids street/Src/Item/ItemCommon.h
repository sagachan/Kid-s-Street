...
namespace
{
	...
	const int		ERASER_DMG = 70;			//消しゴムのダメージ量
	const int		RULER_DMG = 100;
	
	const float		ITEM_GATHER_AREA = 4.0f;	//プレイヤーがアイテムをとったと認めるエリア
	...
	const VECTOR	ERASER_POS = VGet(-640.0f, 5.0f, 890.0f);
	const VECTOR	PENCIL_POS = VGet(-640.0f, 5.0f, 1000.0f);
	const VECTOR	RULER_POS = VGet(-640.0f, 5.0f, 1100.0f);
	const VECTOR	GLOVE_POS = VGet(-640.0f, 5.0f, 1200.0f);
	const VECTOR	pos = VGet(860.0f, 5.0f, 1560.0f);
